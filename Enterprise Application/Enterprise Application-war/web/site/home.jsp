...
<div id="welcome">
	<h1 align="center" style="color: red;">Seja Bem-vindo ao System Mack</h1>
</div>
<br />
<div id="welcome">
...
<!-- Smart Cart HTML Starts -->
  <div id="SmartCart" class="scMain">
      <input type="hidden" pimage="products/product1.jpg" name=""   pprice="2299.99" pdesc="The Intel Core Duo powering MacBook Pro is actually two processors built into a single chip." pcategory="Computers" pname="Apple MacBook Pro MA464LL/A 15.4&quot; Notebook PC" pid="100">
